...
namespace Engine.Services
{
    public class SignalRService : ISignalRService
    {
                ...
                await connection.StartAsync()
                    .ContinueWith(
                        async task =>
                        {
                            ...
                            connection.On<Guid, PlayerCommand>("BotCommandReceived", OnBotCommandReceived);
        ...
        private void OnBotCommandReceived(Guid botId, PlayerCommand playerCommand)
        {
            ...
            {
                foreach (CommandAction action in playerCommand.Actions)
                {
                    actionService.PushPlayerAction(botId, action);
                }
            }
        }
