...
//
//             var activeEffect = WorldStateService.GetActiveEffectByType(bot.Id, Task.GasCloud);
//             var botAfter = WorldStateService.GetState().PlayerGameObjects.Find(g => g.Id == bot.Id);
//
//             Assert.True(activeEffect != default);
//             Assert.True(activeEffect.Task == Task.GasCloud);
//             Assert.True(botAfter != default);
//             Assert.True(botAfter.Tasks == Task.GasCloud);
