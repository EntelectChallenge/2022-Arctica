...
//
//             var activeEffect = WorldStateService.GetActiveEffectByType(bot.Id, Task.AsteroidField);
//             var botAfter = WorldStateService.GetState().PlayerGameObjects.Find(g => g.Id == bot.Id);
//
//             Assert.True(activeEffect != default);
//             Assert.True(activeEffect.Task == Task.AsteroidField);
//             Assert.True(botAfter != default);
//             Assert.True(botAfter.Tasks == Task.AsteroidField);
