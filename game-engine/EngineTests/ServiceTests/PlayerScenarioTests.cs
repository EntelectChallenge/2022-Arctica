...
//             Assert.DoesNotThrow(() => WorldStateService.ApplyAfterTickStateChanges());
//
//             var activeEffect = WorldStateService.GetActiveEffectByType(bot.Id, Task.Superfood);
//             var botAfter = WorldStateService.GetState().PlayerGameObjects.Find(g => g.Id == bot.Id);
//
//             Assert.True(activeEffect != default);
//             Assert.True(activeEffect.Task == Task.Superfood);
//             Assert.True(botAfter != default);
//             Assert.True(botAfter.Tasks == Task.Superfood);
...
//             Assert.DoesNotThrow(() => WorldStateService.ApplyAfterTickStateChanges());
//
//             activeEffect = WorldStateService.GetActiveEffectByType(bot.Id, Task.Superfood);
