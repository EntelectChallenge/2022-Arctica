...
namespace GameRunner
{
    public class RunnerHub : Hub
    {
        ...
        public async Task PublishBotState(GameStateDto gameStateDto)
        {
            ...
            var connectionIds = runnerStateService.GetActiveConnections();

            if (connectionIds.ContainsKey(botState.Id))
            {
            ...
            {
                Logger.LogInfo("Bot Disconnected", $"Bot {botState.Id} is no longer conected to the runner");
            }
